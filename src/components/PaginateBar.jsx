    ...
    return (
        <div>
            <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                ...
                className={` ${num === data.page ? "bg-primary text-white" : "bg-white text-black"} hover:bg-primaryLight cursor-pointer relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0`}>{num}</div>
                )) 
               }
