...
export default function Wishlist(props) {
  ...
  const [wishlistItems, setWishlistItems] = useState(data?.like)


  useEffect(() => {
    setWishlistItems(data?.like)
  }, [data])
        ...
        {wishlistItems?.length === 0 ? <>
          <div className="flex justify-center items-center w-full h-[40vh] gap-[20px]">
            ...
            <div className="flex flex-col gap-[20px] items-center">
              <p className="">Your wishlist is empty. Add funitures your love!</p>
              <Link to="/">
          ...
          <div className="relative bg-white p-[5px] flex flex-col md:flex-col lg:flex-row gap-[40px]">
            ...
            <div className="flex-[6] flex flex-col gap-[20px]">
              <p className="">Wishlist ({wishlistItems?.length})</p>
                    ...
                    <div className="flex justify-end w-full">
                      <div className="flex flex-col sm:flex-row sm:justify-between w-full">
                        ...
                        <div className="flex flex-col gap-[10px]">
                          ...
                          <button onClick={() => addToCart(product)} className="py-[10px] w-[150px] rounded-[6px] bg-primary text-white flex justify-center items-center text-[12px] cursor-pointer hover:bg-black duration-150">Add to Cart</button>
                          </div>
